  ...
  return (
    <>
      ...
      <main className={styles.home}>
        ...
        <h2>através do link da <a href="www.paulinia.sp.gov.br">prefeitura</a></h2>
        <h2>Veja todas as informações no <a href="http://www.paulinia.sp.gov.br/uploads/semanarios/1671.pdf">edital completo</a></h2>
        ...
        <Post titulo="Informes agosto/2021">
          <ul>
            ...
            <li>Aulas presenciais no período da manhã, conforme cronograma já divulgado, com a presença de 50% dos alunos em cada semana</li>
            <li>
              A escola segue com aulas online pelo Google Meet, no período da tarde, e atividades
